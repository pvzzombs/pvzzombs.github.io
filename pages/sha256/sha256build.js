(function(root, factory){
  if (typeof define === 'function' && define.amd) {
    ...
    //////////////////////////////////////////////////////
        ...
        //convert string to ascii code then to binary
    //////////////////////////////////////////////////////
        var str =[];
        ...
        //str = str.join("");
        //console.log(blockOfBytes);
        //console.log(((97 << 8) | 98).toString(2));
        //how to divide 64 bits into 8 blocks of bytes;
        //since 32 bits is equal to 4 blocks of bytes;
        //static cast? 
        //console.log(-1 << 1);
    //////////////////////////////////////////////////////
    
        //Padding the message
        //console.log("message", blockOfBytes.length);
        length = blockOfBytes.length * 8;
        
        var blockOfLength = [];
        //check if its 64bit
        if(sha256TOOLS.word <= length){
          //console.log("It's long")
          for(var lb = 0; lb < 8; lb++){
            blockOfLength[lb] = (length >>> ((7-lb)*8)) & 255;
          }
        }else{
          //console.log("its short");
          blockOfLength = [0, 0, 0, 0];
          for(var lb = 4; lb < 8; lb++){
            blockOfLength[lb] = (length >>> ((7-lb)*8)) & 255;
          }
        }
        //console.log("length",blockOfLength.length);
        ...
        //console.log("Zeroes:", blockOfZeroes.length);
        
        /*var zeroBits = sha256TOOLS.addFrontZero("",sha256TOOLS.mod(448-(length+1), 512));
        var lengthBits = sha256TOOLS.addFrontZero((length).toString(2), 64);
        ...
        length = blockOfBytes.length * 8;
        //console.log("total", blockOfBytes.length)
    //////////////////////////////////////////////////////
